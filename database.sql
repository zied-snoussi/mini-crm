...
CREATE TABLE IF NOT EXISTS prospects (
    ...
    status ENUM('new', 'contacted', 'in negotiation', 'won', 'lost') DEFAULT 'new',
    user_id INT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
('admin', 'admin@example.com', '$2y$10$8WxYR0AIj3UK9jZBEQEOOeQqP7U.1XnbF9yTLF66XjWzs3o/YRjnm');

-- Insert sample prospects
INSERT INTO prospects (name, company, phone, email, status, user_id) VALUES
